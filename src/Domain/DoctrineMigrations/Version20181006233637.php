 ...
 */
final class Version20181006233637 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE p7_phone ADD brand VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP brand_id');
    }
}
